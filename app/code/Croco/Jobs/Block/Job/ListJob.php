<?php
namespace Croco\Jobs\Block\Job;
class ListJob extends \Magento\Framework\View\Element\Template
{
     ...
     * @param \Croco\Jobs\Model\Job $job
    ...
    public function __construct(
        ...
        \Croco\Jobs\Model\Job $job,
        \Croco\Jobs\Model\Department $department,
    ...
    protected function _getJobCollection()
    {
        if ($this->_jobCollection === null) {
            ...
            $jobCollection = $this->_job->getCollection()->addFieldToSelect('*')->join(
