<?php
namespace Croco\Jobs\Controller\Adminhtml\Department;
...
class Edit extends Action
{
     ...
     * @param \Croco\Jobs\Model\Department $model
     */
    public function __construct(
        Action\Context $context,
        \Magento\Framework\View\Result\PageFactory $resultPageFactory,
        \Magento\Framework\Registry $registry,
        \Croco\Jobs\Model\Department $model
    ) {
    ...
    {
        return $this->_authorization->isAllowed('Croco_Jobs::department_save');
    }
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Croco_Jobs::department')
