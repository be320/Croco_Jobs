<?php
namespace Croco\Jobs\Controller\Adminhtml\Job;
...
class Edit extends Action
{
     ...
     * @param \Croco\Jobs\Model\Job $model
     */
    public function __construct(
        Action\Context $context,
        \Magento\Framework\View\Result\PageFactory $resultPageFactory,
        \Magento\Framework\Registry $registry,
        \Croco\Jobs\Model\Job $model
    ) {
    ...
    {
        return $this->_authorization->isAllowed('Croco_Jobs::job_save');
    }
    ...
    protected function _initAction()
    {
        ...
        $resultPage->setActiveMenu('Croco_Jobs::job')
